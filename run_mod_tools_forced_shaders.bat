...
@start /D "%steampath%\steamapps\common\Source SDK Base 2013 Multiplayer" hl2.exe -steam -sw -dev +sv_cheats 1 -console -novid -game "%CD%" -nop4 -tools -force_vendor_id 0x10DE -force_device_id 0x1180
