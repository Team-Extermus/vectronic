...
@start /D "%steampath%\steamapps\common\Source SDK Base 2013 Multiplayer" hl2.exe -steam -sw -dev +sv_cheats 1 -console -novid -game "%CD%" -allowdebug -condebug -full -noborder
